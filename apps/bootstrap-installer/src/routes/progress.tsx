...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Ultron' : 'Setting up Ultron'

  const description = isUpdate
    ? 'Ultron is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Ultron installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
