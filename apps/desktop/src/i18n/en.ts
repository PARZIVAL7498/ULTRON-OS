...
export const en: Translations = {
  ...
  boot: {
    ready: 'Ultron Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Ultron settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Ultron backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Ultron Desktop…'
    },
    errors: {
      backgroundExited: 'Ultron background process exited.',
      backgroundExitedDuringStartup: 'Ultron background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Ultron backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Ultron',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Ultron Desktop.',
    ...
    native: {
      ...
      inputBody: 'Ultron is waiting for your response.',
      turnDoneTitle: 'Ultron finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Ultron defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Ultron backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Ultron backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Ultron is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Ultron asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Ultron was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Ultron was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Ultron follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Ultron can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Ultron is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Ultron, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Ultron Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Ultron runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Ultron checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Ultron configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Ultron.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Ultron gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Ultron Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Ultron Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Ultron runtime managed by this app.',
      kindRemoteDesc: 'A Ultron gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Ultron Cloud account.',
      kindSshDesc: 'A Ultron install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Ultron manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Ultron Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Ultron backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Ultron backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Ultron backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Ultron Cloud',
      cloudDesc: 'Sign in once to Ultron Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Ultron Cloud',
      cloudSignIn: 'Sign in to Ultron Cloud',
      cloudSignedIn: 'Signed in to Ultron Cloud',
      cloudNeedsSignIn: 'Sign in to Ultron Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Ultron Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Ultron Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Ultron Cloud',
      cloudSignedOutMessage: 'Cleared the Ultron Cloud session.',
      ...
      restartingMessage: 'Ultron Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Ultron ${version}` : ''}`,
      ...
      sshDesc:
        'Ultron is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Ultron path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Ultron found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Ultron runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Ultron is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Ultron path.',
      sshErrPlatform:
        'Unsupported remote platform. Ultron Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Ultron on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Ultron. Review the exact configuration below — it comes from the link, not from Ultron.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Ultron runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Ultron at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Ultron builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Ultron to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Ultron to generate pets.',
      backgroundHint: 'You can close this — Ultron will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Ultron desktop' },
    ...
    hermesActiveSessions: (version, count) => `Ultron ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Ultron environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Ultron did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Ultron will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Ultron backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Ultron. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Ultron backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Ultron...',
    placeholderReconnecting: 'Reconnecting to Ultron…',
    ...
    attachUrlDesc: 'Ultron will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Ultron to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Ultron…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Ultron…',
    ...
    unsupportedMessage: 'This version of Ultron can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Ultron is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Ultron backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Ultron from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Ultron will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Ultron desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Ultron updater takes over in its own window and reopens Ultron automatically when it’s done. Please don’t reopen Ultron yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Ultron reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Ultron reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Ultron?',
    blockerBody:
      'Ultron needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Ultron',
    foreignBlockerBody:
      'Ultron can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Ultron can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Ultron needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Ultron Desktop',
    setupChoiceDesc:
      'Connect this app to a Ultron gateway you already run, or install Ultron locally on this computer.',
    connectExistingTitle: 'Connect to existing Ultron',
    ...
    installLocalTitle: 'Install Ultron locally',
    installLocalDesc: 'Download Ultron, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Ultron Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Ultron',
    remoteSetupDesc: 'Enter your gateway URL. Ultron Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Ultron gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Ultron gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Ultron',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Ultron CLI or desktop instance is running. Stop any running Ultron instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Ultron",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Ultron is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Ultron…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Ultron',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Ultron at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Ultron connects automatically',
    ...
    authorizeThere: 'Authorize Ultron there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Ultron there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Ultron Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Ultron Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Ultron will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Ultron is restarting...',
      askRestart: 'Ask Ultron to restart the server',
      lookingRestart: taskId => `Ultron is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Ultron is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Ultron to open a page.',
      finishedRestarting: message => `Ultron finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Ultron could not restart the server.',
      stillWorking:
        'Ultron is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Ultron is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Ultron gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Ultron won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Ultron needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Ultron needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Ultron Desktop to use Save Image.',
    restartToSaveImages: 'Restart Ultron Desktop to save images',
