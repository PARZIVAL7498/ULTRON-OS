"""``ultron tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'ultron tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # ultron tools list [--platform cli]
    ...
    # ultron tools disable <name...> [--platform cli]
    ...
    # ultron tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `ultron tools` runs after you pick a provider that\n"
