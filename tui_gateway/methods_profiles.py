...
def _(rid, params: dict) -> dict:
    ...
    ``ultron setup`` in that flow to recover. A profile spawned as an
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        try:
            ...
            # Toolsets: the same filtered universe the `ultron tools`
            ...
            for ts_name, ts_label, ts_desc in _get_effective_configurable_toolsets():
                ...
                # a per-profile editor — `ultron tools` / Settings is where
