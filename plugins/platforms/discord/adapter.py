...
def _define_discord_view_classes() -> None:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``ultron update`` prompts.
...
# is not in this process (e.g. ``ultron cron`` running standalone) and no live
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `ultron setup` to install Discord support.",
